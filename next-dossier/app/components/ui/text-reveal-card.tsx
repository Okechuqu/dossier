...
export const TextRevealCard = ({
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn("rounded-lg p-8 relative overflow-hidden", className)}
    >
      {children}
      ...
      <div className="h-40 relative flex items-center overflow-hidden">
        <motion.div
          ...
          className="absolute bg-[#1d1c20] rounded-3xl z-20  will-change-transform"
        >
          <p
            style={{
...
export const TextRevealCardTitle = ({
  ...
  return (
    <h1 className={twMerge("text-white text-lg mb-2", className)}>
      {children}
    </h1>
  );
};
