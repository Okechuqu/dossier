...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "hidden md:flex flex-row items-center justify-center gap-2 py-2 rounded-full bg-gray-950/95 border border-[#d4bd89] px-3 shadow-2xl shadow-black/40 backdrop-blur-xl z-50",
        className,
      )}
    >
      {items.map((item) => (
